 ...
 * 
 * 
 * 3.AOP(Aspect Oriented Programmming) 관점지향 프로그래밍
 *    객체지향과 다른개념. 각 객체마다 중복되는 작업들이 있다면
 *    해당 중복 작업을 기준으로 동일 행동을 하게 만드는 것.
 *    매서드가 실행되기전, 실행된 직후, 실행시점에 따라 따로기능을 적용 시키는 것
 */
...
public class BoardController {
	...
	@RequestMapping(value = "/main") //사용자가 main이라고 요청
	public String main() {
		return "main"; //jsp파일명   //아래 해당 jsp파일을 열어준다
	}
	...
	public ModelAndView board() {
		//model
		ModelAndView mv = new ModelAndView("board");  //모델과 뷰를 하나로 합친모양
